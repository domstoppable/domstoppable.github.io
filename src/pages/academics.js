			...
			<div className="page">
				...
				<div className="content">
					<div className="intro">
						...
						<p>While teaching engineering courses, a chance encounter introduced me to human factors research. I quickly realized this was my next new adventure: an opportunity to learn new things while applying my existing skills to improve systems. I completed my MA in 2017 and PhD in 2022.</p>
					</div>
