		...
		return (
			<div className="page">
				...
				<div className="content">
					...
					<p>I'm a scientist, a problem-solver, a software developer, a community leader, and an activist, and I'm always looking for ways to use my talent and skill to improve lives and reduce harm.</p>
					<p>Additionally, I am presently seeking contract and internship opportunities in Human Factors and HCI.</p>
