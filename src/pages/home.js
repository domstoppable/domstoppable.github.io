		...
		return (
			<div className="page">
				...
				<div className="content">
					...
					<p>I'm a scientist, a problem-solver, a software developer, a community leader, and an activist, and I'm always looking for ways to use my talent and skill to improve lives and reduce harm. I have a passion for making technologies more accessible, efficient, and  effective through the thoughtful use of artificial intelligence, automation, and data-driven interaction design.</p>
